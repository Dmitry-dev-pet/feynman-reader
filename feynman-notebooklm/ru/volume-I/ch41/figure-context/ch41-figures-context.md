# Figure context for Глава 41. Броуновское движение
...
## Ch41-F1: Фиг. 41.1. а) Чувствительный зеркальный гальванометр. Пучок света из источника \(L\) отражается от маленького зеркальца на шкале. б) Схематическая запись показаний шкалы как функция времени.
...
## Ch41-F2: Фиг. 41.2. Резонансная цепь с большим \(Q\) . а — реальная цепь при температуре \(T\) ; б — искусственная цепь с идеальным (бесшумным) сопротивлением и «генератором шума» \(G\) .
...
## Ch41-F5: Фиг. 41.5. Уровни энергии гармонического осциллятора расположены на равных расстояниях друг от друга: \(E_n = n\hbar\omega\) .

Section: 41–3 Равнораспределение и квантовый осциллятор
...
## Ch41-F6: Фиг. 41.6. Случайное блуждание из \(36\) шагов длиной \(l\) . Как далеко отстоит \(S_{36}\) от \(B\) ? Ответ: в среднем примерно на \(6l\) .
