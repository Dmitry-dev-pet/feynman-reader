...
### Figure Ch51-F1
Caption: Fig. 51–1.The shock wave front lies on a cone with apex at the source and half-angle \(\theta = \sin^{-1} c_w/v\) .
Image: figures/Ch51-F1.svg
![Fig. 51–1.The shock wave front lies on a cone with apex at the source and half-angle \(\theta = \sin^{-1} c_w/v\) .](figures/Ch51-F1.svg)
...
### Figure Ch51-F2
Caption: Fig. 51–2.A shock wave induced in a gas by a projectile moving faster than sound.
Image: figures/Ch51-F2.svg
![Fig. 51–2.A shock wave induced in a gas by a projectile moving faster than sound.](figures/Ch51-F2.svg)
...
\end{equation*}
\]
If we eliminate \(v\) from this equation by substituting \(vh_2 = u(h_2 -
h_1)\) , already found, and simplify, we get finally that \(u^2 =
gh_2(h_1 + h_2)/2h_1\) .
...
### Figure Ch51-F6
Caption: Fig. 51–6.Schematic of the earth, showing paths of longitudinal and transverse sound waves.
Image: figures/Ch51-F6.svg
![Fig. 51–6.Schematic of the earth, showing paths of longitudinal and transverse sound waves.](figures/Ch51-F6.svg)
...
### Figure Ch51-F9
Caption: Fig. 51–9.Deep-water waves are formed from particles moving in circles. Note the systematic phase shifts from circle to circle. How would a floating object move?
Image: figures/Ch51-F9.svg
![Fig. 51–9.Deep-water waves are formed from particles moving in circles. Note the systematic phase shifts from circle to circle. How would a floating object move?](figures/Ch51-F9.svg)
...
\end{equation*}
\]
where \(T\) is the surface tension and \(\rho\) the density. It is the exact opposite: the phase velocity ishigher, the shorter the wavelength, when the wavelength gets very small. When we have both gravity and capillary action, as we always do, we get the combination of these two together:
\[
\begin{equation*}
...
### Figure Ch51-F11
Caption: Fig. 51–11.Phase velocity vs. wavelength for water.
Image: figures/Ch51-F11.svg
![Fig. 51–11.Phase velocity vs. wavelength for water.](figures/Ch51-F11.svg)
...
### Figure Ch51-F12
Caption: Fig. 51–12.A water wave.
Image: figures/Ch51-F12.svg
![Fig. 51–12.A water wave.](figures/Ch51-F12.svg)
