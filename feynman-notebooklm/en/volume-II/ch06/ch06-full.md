...
\begin{aligned} \mathbf{d}iv{\mathbf{E}}&=\frac{\rho}{\epsilon_0},\\[1ex] \mathbf{c}url{\mathbf{E}}&=\FLPzero. \end{aligned} (6.1)
...
We may, if we wish, completely describe any particular electric field in terms of its potential \phi . We obtain the differential equation that \phi must obey by substituting Eq. ( 6.3) into ( 6.1), to get

\mathbf{d}iv{\boldsymbol{\nabla}{\phi}}=-\frac{\rho}{\epsilon_0}. (6.4)

The divergence of the gradient of \phi is the same as \nabla^2 operating on \phi :

\mathbf{d}iv{\boldsymbol{\nabla}{\phi}}=\nabla^2\phi= \frac{\partial^2\phi}{\partial x^2}+ \frac{\partial^2\phi}{\partial y^2}+ \frac{\partial^2\phi}{\partial z^2}, (6.5)

so we write Eq. ( 6.4) as

\nabla^2\phi=-\frac{\rho}{\epsilon_0}. (6.6)

The operator \nabla^2 is called the Laplacian, and Eq. ( 6.6) is called the Poisson equation. The entire subject of electrostatics, from a mathematical point of view, is merely a study of the solutions of the single equation ( 6.6). Once \phi is obtained by solving Eq. ( 6.6) we can find \mathbf{E} immediately from Eq. ( 6.3).

We take up first the special class of problems in which \rho is given as a function of x , y , z . In that case the problem is almost trivial, for we already know the solution of Eq. ( 6.6) for the general case. We have shown that if \rho is known at every point, the potential at point (1) is

\phi(1)=\int\frac{\rho(2)\,dV_2}{4\pi\epsilon_0 r_{12}}, (6.7)
...
### Figure Ch6-F1
Caption: Fig. 6–1.A dipole: two charges +q+q and −q-q the distance dd apart.
Image: figures/Ch6-F1.svg
![Fig. 6–1.A dipole: two charges +q+q and −q-q the distance dd apart.](figures/Ch6-F1.svg)
...
\begin{aligned} \phi(&x,y,z)\\[.5ex] &=\frac{1}{4\pi\epsilon_0}\!\biggl[ &\frac{q}{\sqrt{[z\!-\!(d/2)]^2\!+\!x^2\!+\!y^2}}\,+\\ &\phantom{\frac{1}{4\pi\epsilon_0}\biggl[} &\frac{-q}{\sqrt{[z\!+\!(d/2)]^2\!+\!x^2\!+\!y^2}}\biggr]. \end{aligned} (6.8)
...
### Figure Ch6-F2
Caption: Fig. 6–2.The water molecule H2_2O. The hydrogen atoms have slightly less than their share of the electron cloud; the oxygen, slightly more.
Image: figures/Ch6-F2.svg
![Fig. 6–2.The water molecule H2_2O. The hydrogen atoms have slightly less than their share of the electron cloud; the oxygen, slightly more.](figures/Ch6-F2.svg)
...
\begin{aligned} \biggl(z-\frac{d}{2}\biggr)^2+x^2+y^2\approx r^2-zd\\[1ex] =r^2\biggl(1-\frac{zd}{r^2}\biggr), \end{aligned}

and

\begin{aligned} \frac{1}{\sqrt{[z-(d/2)]^2+x^2+y^2}}\approx \frac{1}{\sqrt{r^2[1-(zd/r^2)]}}\\[2ex] =\frac{1}{r}\biggl(1-\frac{zd}{r^2}\biggr)^{-1/2}. \end{aligned}

Using the binomial expansion again for [1-(zd/r^2)]^{-1/2} —and throwing away terms with the square or higher powers of d —we get

\frac{1}{r}\biggl(1+\frac{1}{2}\,\frac{zd}{r^2}\biggr).

Similarly,

\frac{1}{\sqrt{[z+(d/2)]^2+x^2+y^2}}\approx \frac{1}{r}\biggl(1-\frac{1}{2}\,\frac{zd}{r^2}\biggr).

The difference of these two terms gives for the potential

\phi(x,y,z)=\frac{1}{4\pi\epsilon_0}\,\frac{z}{r^3}\,qd. (6.9)
...
\phi(x,y,z)=\frac{1}{4\pi\epsilon_0}\,\frac{p\cos\theta}{r^2}, (6.11)

since z/r=\cos\theta , where \theta is the angle between the axis of the dipole and the radius vector to the point (x,y,z) —see Fig. 6–1 . The potential of a dipole decreases as 1/r^2 for a given direction from the axis (whereas for a point charge it goes as 1/r ). The electric field \mathbf{E} of the dipole will then decrease as 1/r^3 .

### Figure Ch6-F3
Caption: Fig. 6–3.Vector notation for a dipole.
Image: figures/Ch6-F3.svg
![Fig. 6–3.Vector notation for a dipole.](figures/Ch6-F3.svg)

We can put our formula into a vector form if we define \mathbf{p} as a vector whose magnitude is p and whose direction is along the axis of the dipole, pointing from -q toward +q . Then

p\cos\theta=\mathbf{p}\cdot\mathbf{e}_r, (6.12)

where \mathbf{e}_r is the unit radial vector (Fig. 6–3 ). We can also represent the point (x,y,z) by \mathbf{r} . Then Dipole potential:

\phi(\mathbf{r})=\frac{1}{4\pi\epsilon_0}\,\frac{\mathbf{p}\cdot\mathbf{e}_r}{r^2}= \frac{1}{4\pi\epsilon_0}\,\frac{\mathbf{p}\cdot\mathbf{r}}{r^3} (6.13)
...
If we want the electric field of the dipole we can get it by taking the gradient of \phi . For example, the z -component of the field is -\frac{\partial \phi}{\partial z} . For a dipole oriented along the z -axis we can use ( 6.9):

-\frac{\partial \phi}{\partial z}=-\frac{p}{4\pi\epsilon_0}\,\frac{\partial }{\partial z}\biggl(\frac{z}{r^3}\biggr) =-\frac{p}{4\pi\epsilon_0}\biggl(\frac{1}{r^3}-\frac{3z^2}{r^5}\biggr),

or

E_z=\frac{p}{4\pi\epsilon_0}\,\frac{3\cos^2\theta-1}{r^3}. (6.14)
...
E_\perp=\frac{p}{4\pi\epsilon_0}\,\frac{3\cos\theta\sin\theta}{r^3}. (6.15)

The transverse component E_\perp is in the xy -plane and points directly away from the axis of the dipole. The total field, of course, is
...
### Figure Ch6-F4
Caption: Fig. 6–4.The electric field of a dipole.
Image: figures/Ch6-F4.svg
![Fig. 6–4.The electric field of a dipole.](figures/Ch6-F4.svg)
...
On the other hand, if you are trying to calculate the divergence of a vector, instead of just looking at \mathbf{d}iv{\mathbf{E}} and wondering what it is, don’t forget that it can always be spread out as
...
### Figure Ch6-F7
Caption: Fig. 6–7.Computation of the potential at a point PP at a large distance from a set of charges.
Image: figures/Ch6-F7.svg
![Fig. 6–7.Computation of the potential at a point PP at a large distance from a set of charges.](figures/Ch6-F7.svg)

We can think of our object as an assembly of point charges q_i in a certain limited region, as shown in Fig. 6–7 . (We can, later, replace q_i by \rho\,dV if we wish.) Let each charge q_i be located at the displacement \mathbf{d}_i from an origin chosen somewhere in the middle of the group of charges. What is the potential at the point P , located at \mathbf{R} , where \mathbf{R} is much larger than the maximum \mathbf{d}_i ? The potential from the whole collection is given by

\phi=\frac{1}{4\pi\epsilon_0}\sum_i\frac{q_i}{r_i}, (6.21)
...
\phi=\frac{1}{4\pi\epsilon_0}\,\frac{1}{R}\sum_iq_i= \frac{Q}{4\pi\epsilon_0 R}, (6.22)
...
\mathbf{p}=\sum_iq_i\mathbf{d}_i (6.26)

as a property of the charge distribution, the second term of the potential ( 6.25) is

\phi=\frac{1}{4\pi\epsilon_0}\,\frac{\mathbf{p}\cdot\mathbf{e}_R}{R^2}, (6.27)
...
### Figure Ch6-F10
Caption: Fig. 6–10.The field of a charge near a plane conducting surface, found by the method of images.
Image: figures/Ch6-F10.svg
![Fig. 6–10.The field of a charge near a plane conducting surface, found by the method of images.](figures/Ch6-F10.svg)

We have now solved for the total field, but what about the real charges that are responsible for it? There are, in addition to our positive point charge, some induced negative charges on the conducting sheet that have been attracted by the positive charge (from large distances away). Now suppose that for some technical reason—or out of curiosity—you would like to know how the negative charges are distributed on the surface. You can find the surface charge density by using the result we worked out in Section 5–9 with Gauss’ law. The normal component of the electric field just outside a conductor is equal to the density of surface charge \sigma divided by \epsilon_0 . We can obtain the density of charge at any point on the surface by working backwards from the normal component of the electric field at the surface. We know that, because we know the field everywhere.

Consider a point on the surface at the distance \rho from the point directly beneath the positive charge (Fig. 6–10 ). The electric field at this point is normal to the surface and is directed into it. The component normal to the surface of the field from the positive point charge is

E_{n+}=-\frac{1}{4\pi\epsilon_0}\,\frac{aq}{(a^2+\rho^2)^{3/2}}. (6.28)

To this we must add the electric field produced by the negative image charge. That just doubles the normal component (and cancels all others), so the charge density \sigma at any point on the surface is

\sigma(\rho)=\epsilon_0 E(\rho)=-\frac{2aq}{4\pi(a^2+\rho^2)^{3/2}}. (6.29)
...
F=\frac{1}{4\pi\epsilon_0}\,\frac{q^2}{(2a)^2}. (6.30)
...
### Figure Ch6-F11
Caption: Fig. 6–11.The point charge qq induces charges on a grounded conducting sphere whose fields are those of an image charge q′q' placed at the point shown.
Image: figures/Ch6-F11.svg
![Fig. 6–11.The point charge qq induces charges on a grounded conducting sphere whose fields are those of an image charge q′q' placed at the point shown.](figures/Ch6-F11.svg)
...
V=Ed=\frac{\sigma}{\epsilon_0}\,d=\frac{d}{\epsilon_0 A}\,Q, (6.33)
...
where C is a constant. This coefficient of proportionality is called the capacity, and such a system of two conductors is called a condenser. 1 For our parallel-plate condenser

C=\frac{\epsilon_0 A}{d}\quad(\text{parallel plates}). (6.34)

### Figure Ch6-F13
Caption: Fig. 6–13.The electric field near the edge of two parallel plates.
Image: figures/Ch6-F13.svg
![Fig. 6–13.The electric field near the edge of two parallel plates.](figures/Ch6-F13.svg)
...
### Figure Ch6-F16
Caption: Fig. 6–16.Field-emission microscope.
Image: figures/Ch6-F16.svg
![Fig. 6–16.Field-emission microscope.](figures/Ch6-F16.svg)
...
### Figure Ch6-F17
Caption: Fig. 6–17.Image produced by a field-emission microscope. [Courtesy of Erwin W. Müller, Research Prof. of Physics, Pennsylvania State University.]
Image: figures/Ch6-F17.jpg
![Fig. 6–17.Image produced by a field-emission microscope. [Courtesy of Erwin W. Müller, Research Prof. of Physics, Pennsylvania State University.]](figures/Ch6-F17.jpg)
