...
### Figure Ch5-F3
Caption: Fig. 5–3.The Thomson model of an atom.
Image: figures/Ch5-F3.svg
![Fig. 5–3.The Thomson model of an atom.](figures/Ch5-F3.svg)
...
### Figure Ch5-F4
Caption: Fig. 5–4.The Rutherford-Bohr model of an atom.
Image: figures/Ch5-F4.svg
![Fig. 5–4.The Rutherford-Bohr model of an atom.](figures/Ch5-F4.svg)
...
### Figure Ch5-F6
Caption: Fig. 5–6.The electric field near a uniformly charged sheet can be found by applying Gauss’ law to an imaginary box.
Image: figures/Ch5-F6.svg
![Fig. 5–6.The electric field near a uniformly charged sheet can be found by applying Gauss’ law to an imaginary box.](figures/Ch5-F6.svg)
...
E_1+E_2=\frac{\sigma}{\epsilon_0}, (5.4)

where E_1 and E_2 are the fields directed outward on each side of the sheet.

### Figure Ch5-F7
Caption: Fig. 5–7.The field between two charged sheets is σ/ϵ0\sigma/\epsO.
Image: figures/Ch5-F7.svg
![Fig. 5–7.The field between two charged sheets is σ/ϵ0\sigma/\epsO.](figures/Ch5-F7.svg)
...
\begin{aligned} &E\,(\text{between the sheets})&\,=&\,\sigma/\epsilon_0,\\[2ex] &E\,(\text{outside}) &\,=&\,0. \end{aligned} (5.5)
...
## 5–8 Is the field of a point charge exactly 1/r2\boldsymbol{1/r^2}?
...
### Figure Ch5-F9
Caption: Fig. 5–9.The field is zero at any point PP inside a spherical shell of charge.
Image: figures/Ch5-F9.svg
![Fig. 5–9.The field is zero at any point PP inside a spherical shell of charge.](figures/Ch5-F9.svg)

If the surface of the sphere is uniformly charged, the charge \Delta q on each of the elements of area is proportional to the area, so
...
### Figure Ch5-F10
Caption: Fig. 5–10.The electric field is zero inside a closed conducting shell.
Image: figures/Ch5-F10.svg
![Fig. 5–10.The electric field is zero inside a closed conducting shell.](figures/Ch5-F10.svg)
