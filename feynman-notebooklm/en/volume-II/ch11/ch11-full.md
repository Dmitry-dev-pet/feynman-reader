...
E_0=E+\frac{P}{\epsilon_0}, (11.22)

where E is again the electric field in the dielectric. (The Gaussian surface contains the surface polarization charge \sigma_{\text{pol}}=P .) We mentioned in Chapter 10 that \epsilon_0 E+P is often called D , so \epsilon_0 E_0=D_0 is equal to D in the dielectric.
...
### Figure Ch11-F6
Caption: Fig. 11–6.The field at any point AA in a dielectric can be considered as the sum of the field in a spherical hole plus the field due to a spherical plug.
Image: figures/Ch11-F6.svg
![Fig. 11–6.The field at any point AA in a dielectric can be considered as the sum of the field in a spherical hole plus the field due to a spherical plug.](figures/Ch11-F6.svg)
...
E=E_{\text{hole}}+E_{\text{plug}}, (11.23)

where E_{\text{hole}} is the field in the hole and E_{\text{plug}} is the field inside a sphere which is uniformly polarized (see Fig. 11–6 ). The fields due to a uniformly polarized sphere are shown in Fig. 11–7 . The electric field inside the sphere is uniform, and its value is

E_{\text{plug}}=-\frac{P}{3\epsilon_0}. (11.24)

Using ( 11.23), we get

E_{\text{hole}}=E+\frac{P}{3\epsilon_0}. (11.25)
...
### Figure Ch11-F7
Caption: Fig. 11–7.The electric field of a uniformly polarized sphere.
Image: figures/Ch11-F7.svg
![Fig. 11–7.The electric field of a uniformly polarized sphere.](figures/Ch11-F7.svg)
