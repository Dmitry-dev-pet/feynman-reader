...
U=\frac{1}{2}\,\frac{Q^2}{C}. (8.9)

This energy can also be written as

U=\frac{1}{2}CV^2. (8.10)
...
U=\frac{1}{2}\,\frac{Q^2}{4\pi\epsilon_0 a}. (8.11)
...
Let’s use this method for determining the force between the plates of a parallel-plate condenser. If we imagine that the spacing of the plates is increased by the small amount \Delta z , then the mechanical work done from the outside in moving the plates would be

\Delta W=F\,\Delta z, (8.12)
...
\Delta U=\frac{1}{2}\,Q^2\,\Delta\biggl(\frac{1}{C}\biggr). (8.13)

Equating ( 8.12) and ( 8.13), we have

F\,\Delta z=\frac{Q^2}{2}\,\Delta\biggl(\frac{1}{C}\biggr). (8.14)

This can also be written as

F\,\Delta z=-\frac{Q^2}{2C^2}\,\Delta C. (8.15)
...
### Figure Ch8-F3
Caption: Fig. 8–3.What is the torque on a variable capacitor?
Image: figures/Ch8-F3.svg
![Fig. 8–3.What is the torque on a variable capacitor?](figures/Ch8-F3.svg)
...
\frac{1}{C}=\frac{d}{\epsilon_0 A}, (8.16)

where A is the area of each plate. If we increase the separation by \Delta z ,

\Delta\biggl(\frac{1}{C}\biggr)=\frac{\Delta z}{\epsilon_0 A}.

From Eq. ( 8.14) we get that the force between the plates is

F=\frac{Q^2}{2\epsilon_0 A}. (8.17)
...
### Figure Ch8-F4
Caption: Fig. 8–4.The field at the surface of a conductor varies from zero to E0=σ/ϵ0E_0=\sigma/\epsO, as one passes through the layer of surface charge.
Image: figures/Ch8-F4.svg
![Fig. 8–4.The field at the surface of a conductor varies from zero to E0=σ/ϵ0E_0=\sigma/\epsO, as one passes through the layer of surface charge.](figures/Ch8-F4.svg)
...
### Figure Ch8-F6
Caption: Fig. 8–6.The force between two protons depends on every possible parameter.
Image: figures/Ch8-F6.svg
![Fig. 8–6.The force between two protons depends on every possible parameter.](figures/Ch8-F6.svg)
...
### Figure Ch8-F7
Caption: Fig. 8–7.The energy levels of B11^{11} and C11^{11} (energies in MeV). The ground state of C11^{11} is 1.9821.982 MeV higher than that of B11^{11}.
Image: figures/Ch8-F7.svg
![Fig. 8–7.The energy levels of B11^{11} and C11^{11} (energies in MeV). The ground state of C11^{11} is 1.9821.982 MeV higher than that of B11^{11}.](figures/Ch8-F7.svg)
...
Looking at Fig. 8–7, we see a striking similarity between the pattern of the energy levels in the two nuclei. The first excited states are about 2 MeV above the ground states. There is a large gap of about 2.3 MeV to the second excited state, then a small jump of only 0.5 MeV to the third level. Again, between the fourth and fifth levels, a big jump; but between the fifth and sixth a tiny separation of the order of 0.1 MeV. And so on. After about the tenth level, the correspondence seems to become lost, but can still be seen if the levels are labeled with their other defining characteristics—for instance, their angular momentum and what they do to lose their extra energy.
...
U=\frac{3}{5}\,\frac{(Zq_e)^2}{4\pi\epsilon_0 r}. (8.22)
...
U=\frac{3}{5}\,\frac{Z(Z-1)q_e^2}{4\pi\epsilon_0 r}= \frac{3}{5}\,\frac{Z(Z-1)e^2}{r}. (8.23)
...
That is, however, not quite right. The energy difference of 1.982 MeV between the ground states of B ^{11} and C ^{11} includes the rest energies—that is, the energy mc^2 —of all the particles. In going from B ^{11} to C ^{11} , we replace a neutron by a proton and an electron, which have less mass. So part of the energy difference is the difference in the rest energies of a neutron and that of a proton plus an electron, which is 0.784 MeV. The difference, to be accounted for by electrostatic energy, is thus more than 1.982 MeV; it is

1.982\text{ MeV}+0.784\text{ MeV}=2.766\text{ MeV}.

Using this energy in Eq. ( 8.23), for the radius of either B ^{11} or C ^{11} we find

r=3.12\times10^{-13}\text{ cm}. (8.24)
...
\frac{Z_Bq_e^2}{4\pi\epsilon_0 r}
...
U=\int\limits_{r=0}^\infty\frac{q^2}{8\pi\epsilon_0 r^2}\,dr= \left.-\frac{q^2}{8\pi\epsilon_0}\,\frac{1}{r}\right|_{r=0}^{r=\infty}. (8.36)
