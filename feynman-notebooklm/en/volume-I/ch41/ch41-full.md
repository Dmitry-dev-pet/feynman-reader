...
LANGUAGE: en
TITLE: Chapter 41. The Brownian Movement
...
### Figure Ch41-F1
Caption: Fig. 41–1.(a) A sensitive light-beam galvanometer. Light from a source \(L\) is reflected from a small mirror onto a scale. (b) A schematic record of the reading of the scale as a function of the time.
Image: figures/Ch41-F1.svg
![Fig. 41–1.(a) A sensitive light-beam galvanometer. Light from a source \(L\) is reflected from a small mirror onto a scale. (b) A schematic record of the reading of the scale as a function of the time.](figures/Ch41-F1.svg)
...
### Figure Ch41-F2
Caption: Fig. 41–2.A high- \(Q\) resonant circuit. (a) Actual circuit, at temperature \(T\) . (b) Artificial circuit, with an ideal (noiseless) resistance and a “noise generator” \(G\) .
Image: figures/Ch41-F2.svg
![Fig. 41–2.A high- \(Q\) resonant circuit. (a) Actual circuit, at temperature \(T\) . (b) Artificial circuit, with an ideal (noiseless) resistance and a “noise generator” \(G\) .](figures/Ch41-F2.svg)
...
### Figure Ch41-F3
Caption: Fig. 41–3.The factors in the integrand (41.10). The peak is the resonance curve \(1/\bigl[(\omega - \omega_0)^2 + \gamma^2/4\bigr]\) . To a good approximation the factor \(I(\omega)\) can be replaced by \(I(\omega_0)\) .
Image: figures/Ch41-F3.svg
![Fig. 41–3.The factors in the integrand (41.10). The peak is the resonance curve \(1/\bigl[(\omega - \omega_0)^2 + \gamma^2/4\bigr]\) . To a good approximation the factor \(I(\omega)\) can be replaced by \(I(\omega_0)\) .](figures/Ch41-F3.svg)
...
### Figure Ch41-F4
Caption: Fig. 41–4.The blackbody intensity distribution at two temperatures, according to classical physics (solid curves). The dashed curves show the actual distribution.
Image: figures/Ch41-F4.svg
![Fig. 41–4.The blackbody intensity distribution at two temperatures, according to classical physics (solid curves). The dashed curves show the actual distribution.](figures/Ch41-F4.svg)
...
### Figure Ch41-F5
Caption: Fig. 41–5.The energy levels of a harmonic oscillator are equally spaced: \(E_n = n\hbar\omega\) .
Image: figures/Ch41-F5.svg
![Fig. 41–5.The energy levels of a harmonic oscillator are equally spaced: \(E_n = n\hbar\omega\) .](figures/Ch41-F5.svg)
...
### Figure Ch41-F6
Caption: Fig. 41–6.A random walk of \(36\) steps of length \(l\) . How far is \(S_{36}\) from \(B\) ?Ans:about \(6l\) on the average.
Image: figures/Ch41-F6.svg
![Fig. 41–6.A random walk of \(36\) steps of length \(l\) . How far is \(S_{36}\) from \(B\) ?Ans:about \(6l\) on the average.](figures/Ch41-F6.svg)
