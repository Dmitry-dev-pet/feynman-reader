...
LANGUAGE: en
TITLE: Chapter 5. Time and Distance
...
We may count off beats of a pulse as the ball rolls down the track: “one … two … three … four … five … six … seven … eight …” We ask a friend to make a small mark at the location of the ball at each count; we can then measure thedistancethe ball travelled from the point of release in one, or two, or three, etc., equal intervals of time. Galileo expressed the result ofhisobservations in this way: if the location of the ball is marked at \(1\) , \(2\) , \(3\) , \(4\) , … units of time from the instant of its release, those marks are distant from the starting point in proportion to the numbers \(1\) , \(4\) , \(9\) , \(16\) , … Today we would say the distance is proportional to the square of the time:
\[
\begin{equation*}
D\propto t^2.
\end{equation*}
...
### Figure Ch5-F1
Caption: Fig. 5–1.A ball rolls down an inclined track.
Image: figures/Ch5-F1.svg
![Fig. 5–1.A ball rolls down an inclined track.](figures/Ch5-F1.svg)


The study ofmotion, which is basic to all of physics, treats with the questions: where? and when?
...
### Figure Ch5-F2
Caption: Fig. 5–2.Two views of an oscilloscope screen. In (a) the oscilloscope is connected to one oscillator, in (b) it is connected to an oscillator with a period one-tenth as long.
Image: figures/Ch5-F2.svg
![Fig. 5–2.Two views of an oscilloscope screen. In (a) the oscilloscope is connected to one oscillator, in (b) it is connected to an oscillator with a period one-tenth as long.](figures/Ch5-F2.svg)
...
### Figure Ch5-F3
Caption: Fig. 5–3.The decrease with time of radioactivity. The activity decreases by one-half in each “half-life,” \(T\) .
Image: figures/Ch5-F3.svg
![Fig. 5–3.The decrease with time of radioactivity. The activity decreases by one-half in each “half-life,” \(T\) .](figures/Ch5-F3.svg)
...
### Figure Ch5-F4
Caption: Fig. 5–4.The height of a Sputnik is determined by triangulation.
Image: figures/Ch5-F4.svg
![Fig. 5–4.The height of a Sputnik is determined by triangulation.](figures/Ch5-F4.svg)
...
### Figure Ch5-F5
Caption: Fig. 5–5.The distance of nearby stars can be measured by triangulation, using the diameter of the earth’s orbit as a baseline.
Image: figures/Ch5-F5.svg
![Fig. 5–5.The distance of nearby stars can be measured by triangulation, using the diameter of the earth’s orbit as a baseline.](figures/Ch5-F5.svg)
...
### Figure Ch5-F6
Caption: Fig. 5–6.A cluster of stars near the center of our galaxy. Their distance from the earth is \(30{,}000\) light-years, or about \(3\times10^{20}\) meters.
Image: figures/Ch5-F6.svg
![Fig. 5–6.A cluster of stars near the center of our galaxy. Their distance from the earth is \(30{,}000\) light-years, or about \(3\times10^{20}\) meters.](figures/Ch5-F6.svg)
...
### Figure Ch5-F7
Caption: Fig. 5–7.A spiral galaxy like our own. Presuming that its diameter is similar to that of our own galaxy, we may compute its distance from its apparent size. It is \(30\) million light-years \((3\times10^{23}\text{meters})\) from the earth.
Image: figures/Ch5-F7.svg
![Fig. 5–7.A spiral galaxy like our own. Presuming that its diameter is similar to that of our own galaxy, we may compute its distance from its apparent size. It is \(30\) million light-years \((3\times10^{23}\text{meters})\) from the earth.](figures/Ch5-F7.svg)
...
### Figure Ch5-F8
Caption: Fig. 5–8.The most distant object, 3C 295 in Boötes (indicated by the arrow), measured by the \(200\) -inch telescope to date (1960).
Image: figures/Ch5-F8.svg
![Fig. 5–8.The most distant object, 3C 295 in Boötes (indicated by the arrow), measured by the \(200\) -inch telescope to date (1960).](figures/Ch5-F8.svg)
...
### Figure Ch5-F9
Caption: Fig. 5–9.Electron micrograph of some virus molecules. The “large” sphere is for calibration and is known to have a diameter of \(2\times10^{-7}\) meter ( \(2000\) Å).
Image: figures/Ch5-F9.svg
![Fig. 5–9.Electron micrograph of some virus molecules. The “large” sphere is for calibration and is known to have a diameter of \(2\times10^{-7}\) meter ( \(2000\) Å).](figures/Ch5-F9.svg)
...
\end{equation*}
\]
From such an experiment we find that the radii of the nuclei are from about \(1\) to \(6\) times \(10^{-15}\) meter. The length unit \(10^{-15}\) meter is called thefermi, in honor of Enrico Fermi (1901–1954).
...
\end{equation*}
\]
where \(\Delta E\) is the error in our knowledge of the energy of the process whose time period we are measuring. If we wish to knowmorepreciselywhensomething happened we must know less aboutwhathappened, because our knowledge of the energy involved will be less. The time uncertainty is also related to the wave nature of matter.
