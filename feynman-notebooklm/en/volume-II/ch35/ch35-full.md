...
When an atom has two levels which differ in energy by the amount \Delta U , it can make a transition from the upper level to the lower level by emitting a light quantum of frequency \omega , where

\hbar\omega=\Delta U. (35.7)
...
### Figure Ch35-F3
Caption: Fig. 35–3. The classical precession of an atom with the magnetic moment μ\Figmu and the angular momentum J\FigJ.
Image: figures/Ch35-F3.svg
![Fig. 35–3. The classical precession of an atom with the magnetic moment μ\Figmu and the angular momentum J\FigJ.](figures/Ch35-F3.svg)
...
### Figure Ch35-F4
Caption: Fig. 35–4. The angle of precession of an atomic magnet can be changed by a horizontal magnetic field always at right angles to μ\Figmu, as in (a), or by an oscillating field, as in (b).
Image: figures/Ch35-F4.svg
![Fig. 35–4. The angle of precession of an atomic magnet can be changed by a horizontal magnetic field always at right angles to μ\Figmu, as in (a), or by an oscillating field, as in (b).](figures/Ch35-F4.svg)
...
In the gap of magnet 2 there is a set of coils that produces a small horizontal magnetic field \mathbf{B}' . The coils are driven with a current which oscillates at a variable frequency \omega . So between the poles of magnet 2 there is a strong, constant, vertical field \mathbf{B}_0 and a weak, oscillating, horizontal field \mathbf{B}' .

Suppose now that the frequency \omega of the oscillating field is set at \omega_p —the “precession” frequency of the atoms in the field \mathbf{B} . The alternating field will cause some of the atoms passing by to make transitions from one J_z to the other. An atom whose spin was initially “up” ( J_z=+\hbar/2 ) may be flipped “down” ( J_z=-\hbar/2 ). Now this atom has the direction of its magnetic moment reversed, so it will feel a downward force in magnet 3 and will move along the path a' , shown in Fig. 35-5 . It will no longer get through the slit S_2 to the detector. Similarly, some of the atoms whose spins were initially down ( J_z=-\hbar/2 ) will have their spins flipped up ( J_z=+\hbar/2 ) as they pass through magnet 2 . They will then go along the path b' and will not get to the detector.

If the oscillating field \mathbf{B}' has a frequency appreciably different from \omega_p , it will not cause any spin flips, and the atoms will follow their undisturbed paths to the detector. So you can see that the “precession” frequency \omega_p of the atoms in the field \mathbf{B}_0 can be found by varying the frequency \omega of the field \mathbf{B}' until a decrease is observed in the current of atoms arriving at the detector. A decrease in the current will occur when \omega is “in resonance” with \omega_p . A plot of the detector current as a function of \omega might look like the one shown in Fig. 35-6 . Knowing \omega_p , we can obtain the g -value of the atom.

### Figure Ch35-F6
Caption: Fig. 35–6. The current of atoms in the beam decreases when ω=ωp\omega=\omega_p.
Image: figures/Ch35-F6.svg
![Fig. 35–6. The current of atoms in the beam decreases when ω=ωp\omega=\omega_p.](figures/Ch35-F6.svg)

Such atomic-beam or, as they are usually called, “molecular” beam resonance experiments are a beautiful and delicate way of measuring the magnetic properties of atomic objects. The resonance frequency \omega_p can be determined with great precision—in fact, with a greater precision than we can measure the magnetic field \mathbf{B}_0 , which we must know to find g .
...
We define the magnetization \FLPM of a material as the net magnetic moment per unit volume, by which we mean the vector sum of all the atomic magnetic moments in a unit volume. If there are N atoms per unit volume and their average moment is \av{\FLPmu} then \FLPM can be written as N times the average atomic moment:

\FLPM=N\av{\FLPmu}. (35.8)

The definition of \FLPM corresponds to the definition of the electric polarization \FLPP of Chapter 10.

The classical theory of paramagnetism is just like the theory of the dielectric constant we showed you in Chapter 11. One assumes that each of the atoms has a magnetic moment \FLPmu , which always has the same magnitude but which can point in any direction. In a field \mathbf{B} , the magnetic energy is -\FLPmu\cdot\mathbf{B}=-\mu B\cos\theta , where \theta is the angle between the moment and the field. From statistical mechanics, the relative probability of having any angle is e^{-\text{energy}/kT} , so angles near zero are more likely than angles near \pi . Proceeding exactly as we did in Section 11-3 , we find that for small magnetic fields \FLPM is directed parallel to \mathbf{B} and has the magnitude

M=\frac{N\mu^2B}{3kT}. (35.9)

[See Eq. ( 11.20).] This approximate formula is correct only for \mu B/kT much less than one.
...
Now we want to look at paramagnetism from the point of view of quantum mechanics. We take first the case of an atom with a spin of 1/2 . In the absence of a magnetic field the atoms have a certain energy, but in a magnetic field there are two possible energies, one for each value of J_z . For J_z=+\hbar/2 , the energy is changed by the magnetic field by the amount

\Delta U_1=+g\biggl(\frac{q_e\hbar}{2m}\biggr)\cdot\frac{1}{2}\cdot B. (35.10)

(The energy shift \Delta U is positive for an atom because the electron charge is negative.) For J_z=-\hbar/2 , the energy is changed by the amount

\Delta U_2=-g\biggl(\frac{q_e\hbar}{2m}\biggr)\cdot\frac{1}{2}\cdot B. (35.11)

To save writing, let’s set

\mu_0=g\biggl(\frac{q_e\hbar}{2m}\biggr)\cdot\frac{1}{2}; (35.12)

then

\Delta U=\pm\mu_0B. (35.13)

The meaning of \mu_0 is clear: -\mu_0 is the z -component of the magnetic moment in the up-spin case, and +\mu_0 is the z -component of the magnetic moment in the down-spin case.

Now statistical mechanics tells us that the probability that an atom is in one state or another is proportional to

e^{-(\text{Energy of state})/kT}.

With no magnetic field the two states have the same energy; so when there is equilibrium in a magnetic field, the probabilities are proportional to

e^{-\Delta U/kT}. (35.14)

The number of atoms per unit volume with spin up is

N_{\text{up}}=ae^{-\mu_0B/kT}, (35.15)

and the number with spin down is

N_{\text{down}}=ae^{+\mu_0B/kT}. (35.16)

The constant a is to be determined so that

N_{\text{up}}+N_{\text{down}}=N, (35.17)

the total number of atoms per unit volume. So we get that

a=\frac{N}{e^{+\mu_0B/kT}+e^{-\mu_0B/kT}}. (35.18)

What we are interested in is the average magnetic moment along the z -axis. The atoms with spin up will contribute a moment of -\mu_0 , and those with spin down will have a moment of +\mu_0 ; so the average moment is

\av{\mu} = \frac{N_{\text{up}}(-\mu_0)+N_{\text{down}}(+\mu_0)}{N}. (35.19)

The magnetic moment per unit volume M is then N\av{\mu} . Using Eqs. ( 35.15), ( 35.16), and ( 35.17), we get that

M=N\mu_0\, \frac{e^{+\mu_0B/kT}-e^{-\mu_0B/kT}}{e^{+\mu_0B/kT}+e^{-\mu_0B/kT}}. (35.20)

This is the quantum-mechanical formula for M for atoms with j=1/2 . Incidentally, this formula can also be written somewhat more concisely in terms of the hyperbolic tangent function:

M=N\mu_0\,\tanh\frac{\mu_0B}{kT}. (35.21)

### Figure Ch35-F7
Caption: Fig. 35–7. The variation of the paramagnetic magnetization with the magnetic field strength BB.
Image: figures/Ch35-F7.svg
![Fig. 35–7. The variation of the paramagnetic magnetization with the magnetic field strength BB.](figures/Ch35-F7.svg)
...
In most normal cases—say, for typical moments, room temperatures, and the fields one can normally get (like 10{,}000 gauss)—the ratio \mu_0B/kT is about 0.002 . One must go to very low temperatures to see the saturation. For normal temperatures, we can usually replace \tanh x by x , and write

M=\frac{N\mu_0^2B}{kT}. (35.22)
...
In the classical formula, what appears is \mu^2=\FLPmu\cdot\FLPmu , the square of the vector magnetic moment, or

\FLPmu\cdot\FLPmu=\biggl(g\,\frac{q_e}{2m}\biggr)^2\FLPJ\cdot\FLPJ. (35.23)

We pointed out in the last chapter that you can very likely get the right answer from a classical calculation by replacing \FLPJ\cdot\FLPJ by j(j+1)\hbar^2 . In our particular example, we have j=1/2 , so

j(j+1)\hbar^2=\frac{3}{4}\hbar^2.

Substituting this for \FLPJ\cdot\FLPJ in Eq. ( 35.23), we get

\FLPmu\cdot\FLPmu=\biggl(g\,\frac{q_e}{2m}\biggr)^2 \frac{3\hbar^2}{4},

or in terms of \mu_0 , defined in Eq. ( 35.12), we get

\FLPmu\cdot\FLPmu=3\mu_0^2.

Substituting this for \mu^2 in the classical formula, Eq. ( 35.9), does indeed reproduce the correct quantum formula, Eq. ( 35.22).

The quantum theory of paramagnetism is easily extended to atoms of any spin j . The low-field magnetization is

M=Ng^2\,\frac{j(j+1)}{3}\,\frac{\mu_B^2B}{kT}, (35.24)

where

\mu_B=\frac{q_e\hbar}{2m} (35.25)
...
Just as in the Rabi molecular-beam experiment, the energy absorption will be seen only when the oscillating field is in resonance, that is, when

\omega=\omega_p=g\biggl(\frac{q_e}{2m_p}\biggr)B.

It is often more convenient to search for the resonance by varying B while keeping \omega fixed. The energy absorption will evidently appear when
...
### Figure Ch35-F8
Caption: Fig. 35–8. A nuclear magnetic resonance apparatus.
Image: figures/Ch35-F8.svg
![Fig. 35–8. A nuclear magnetic resonance apparatus.](figures/Ch35-F8.svg)
