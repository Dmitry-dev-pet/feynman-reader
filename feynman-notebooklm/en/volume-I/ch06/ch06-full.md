...
### Figure Ch6-F1
Caption: Fig. 6–1.Observed sequences of heads and tails in three games of 30 tosses each.
Image: figures/Ch6-F1.svg
![Fig. 6–1.Observed sequences of heads and tails in three games of 30 tosses each.](figures/Ch6-F1.svg)
...
Caption: Table 6–1Number of heads in successive trials of 30 tosses of a coin.
...
### Figure Ch6-F2
Caption: Fig. 6–2.Summary of the results of 100 games of 30 tosses each. The vertical bars show the number of games in which a score of \(k\) heads was obtained. The dashed curve shows the expected numbers of games with the score \(k\) obtained by a probability computation.
Image: figures/Ch6-F2.svg
![Fig. 6–2.Summary of the results of 100 games of 30 tosses each. The vertical bars show the number of games in which a score of \(k\) heads was obtained. The dashed curve shows the expected numbers of games with the score \(k\) obtained by a probability computation.](figures/Ch6-F2.svg)
...
### Figure Ch6-F3
Caption: Fig. 6–3.A diagram for showing the number of ways a score of 0, 1, 2, or 3 heads can be obtained in a game of 3 tosses.
Image: figures/Ch6-F3.svg
![Fig. 6–3.A diagram for showing the number of ways a score of 0, 1, 2, or 3 heads can be obtained in a game of 3 tosses.](figures/Ch6-F3.svg)


### Figure Ch6-F4
Caption: Fig. 6–4.A diagram like that of Fig.6–3, for a game of 6 tosses.
Image: figures/Ch6-F4.svg
![Fig. 6–4.A diagram like that of Fig.6–3, for a game of 6 tosses.](figures/Ch6-F4.svg)
...
### Figure Ch6-F5
Caption: Fig. 6–5.The progress made in a random walk. The horizontal coordinate \(N\) is the total number of steps taken; the vertical coordinate \(D_N\) is the net distance moved from the starting position.
Image: figures/Ch6-F5.svg
![Fig. 6–5.The progress made in a random walk. The horizontal coordinate \(N\) is the total number of steps taken; the vertical coordinate \(D_N\) is the net distance moved from the starting position.](figures/Ch6-F5.svg)
...
### Figure Ch6-F6
Caption: Fig. 6–6.The fraction of the tosses that gave heads in a particular sequence of \(N\) tosses of a penny.
Image: figures/Ch6-F6.svg
![Fig. 6–6.The fraction of the tosses that gave heads in a particular sequence of \(N\) tosses of a penny.](figures/Ch6-F6.svg)
...
### Figure Ch6-F7
Caption: Fig. 6–7.The probability density for ending up at the distance \(D\) from the starting place in a random walk of \(N\) steps. ( \(D\) is measured in units of the rms step length.)
Image: figures/Ch6-F7.svg
![Fig. 6–7.The probability density for ending up at the distance \(D\) from the starting place in a random walk of \(N\) steps. ( \(D\) is measured in units of the rms step length.)](figures/Ch6-F7.svg)
...
### Figure Ch6-F8
Caption: Fig. 6–8.The probability that the distance \(D\) traveled in a random walk is between \(x_1\) and \(x_2\) is the area under the curve of \(p(x)\) from \(x_1\) to \(x_2\) .
Image: figures/Ch6-F8.svg
![Fig. 6–8.The probability that the distance \(D\) traveled in a random walk is between \(x_1\) and \(x_2\) is the area under the curve of \(p(x)\) from \(x_1\) to \(x_2\) .](figures/Ch6-F8.svg)
...
### Figure Ch6-F9
Caption: Fig. 6–9.The distribution of velocities of the molecules in a gas.
Image: figures/Ch6-F9.svg
![Fig. 6–9.The distribution of velocities of the molecules in a gas.](figures/Ch6-F9.svg)
...
### Figure Ch6-F10
Caption: Fig. 6–10.Probability densities for observation of the position and velocity of a particle.
Image: figures/Ch6-F10.svg
![Fig. 6–10.Probability densities for observation of the position and velocity of a particle.](figures/Ch6-F10.svg)
...
### Figure Ch6-F11
Caption: Fig. 6–11.A way of visualizing a hydrogen atom. The density (whiteness) of the cloud represents the probability density for observing the electron.
Image: figures/Ch6-F11.svg
![Fig. 6–11.A way of visualizing a hydrogen atom. The density (whiteness) of the cloud represents the probability density for observing the electron.](figures/Ch6-F11.svg)
