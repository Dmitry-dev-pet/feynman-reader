...
LANGUAGE: ru
TITLE: Глава 37. Квантовое поведение
...
### Figure Ch37-F1
Caption: Фиг. 37.1. Опыт со стрельбой из пулемета.
Image: figures/Ch37-F1.svg
![Фиг. 37.1. Опыт со стрельбой из пулемета.](figures/Ch37-F1.svg)
...
### Figure Ch37-F2
Caption: Фиг. 37.2. Опыт с волнами на воде.
Image: figures/Ch37-F2.svg
![Фиг. 37.2. Опыт с волнами на воде.](figures/Ch37-F2.svg)
...
Вы увидите, что этот результат совсем не похож на тот, что получается с пулями (уравнение 37.1). Раскрыв \(\abs{\hat{h}_1 +
\hat{h}_2}^2\) , мы увидим, что
\[
\begin{equation}
\label{Eq:I:37:3}
...
### Figure Ch37-F3
Caption: Фиг. 37.3. Интерференционный опыт с электронами.
Image: figures/Ch37-F3.svg
![Фиг. 37.3. Интерференционный опыт с электронами.](figures/Ch37-F3.svg)
...
### Figure Ch37-F4
Caption: Фиг. 37.4. Другой опыт с электронами.
Image: figures/Ch37-F4.svg
![Фиг. 37.4. Другой опыт с электронами.](figures/Ch37-F4.svg)
...
### Figure Ch37-F5
Caption: Фиг. 37.5. Интерференционная картина при рассеянии пуль: а — истинная (схематично), б — наблюдаемая.
Image: figures/Ch37-F5.svg
![Фиг. 37.5. Интерференционная картина при рассеянии пуль: а — истинная (схематично), б — наблюдаемая.](figures/Ch37-F5.svg)
...
### Figure Ch37-F6
Caption: Фиг. 37.6. Опыт, в котором измеряется отдача стенки.
Image: figures/Ch37-F6.svg
![Фиг. 37.6. Опыт, в котором измеряется отдача стенки.](figures/Ch37-F6.svg)
